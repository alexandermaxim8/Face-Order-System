...
if idToken and user:
    ...
    if konfirmasi_pressed:
        ...
        if len(st.session_state.EAR_buffer) < 5:
            st.warning("Data EAR belum cukup, tunggu beberapa detik sebelum menekan konfirmasi.")
        else:
            st.session_state.sudah_pencet = True
            # Hitung threshold sekali saja
            ...
            # Pastikan EAR_THRESHOLD2 sedikit lebih tinggi dari EAR_THRESHOLD1
        ...
        while cap.isOpened() and not st.session_state.stop_clicked:
            ...
            if faces:
                ...
                if not st.session_state.sudah_pencet:
                    ...
                    # Threshold sudah dihitung satu kali diatas
